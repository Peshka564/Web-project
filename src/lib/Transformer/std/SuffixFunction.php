...
class SuffixFunction implements TransformerFunction
{
    ...
    {
        if (count($args) !== 2) {
            throw new EvaluationException("Suffix function needs 2 string arguments");
        }
        ...
        $result = str_ends_with($leftValue, $rightValue);
